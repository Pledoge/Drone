...
#define IMU_HEAT_Pin GPIO_PIN_4
#define IMU_HEAT_GPIO_Port GPIOA
#define USART1C_TX_Pin GPIO_PIN_4
#define USART1C_TX_GPIO_Port GPIOC
#define USART1C_RX_Pin GPIO_PIN_5
#define USART1C_RX_GPIO_Port GPIOC
#define ICM_CS_Pin GPIO_PIN_12
#define ICM_CS_GPIO_Port GPIOB
#define ADC_POWER_Pin GPIO_PIN_8
#define ADC_POWER_GPIO_Port GPIOA
#define ADC_5V_Pin GPIO_PIN_9
